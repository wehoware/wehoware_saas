...
import {
  ...
  FilterIcon, FileText, CheckCircle, AlertTriangle, XCircle, Clock, Loader2, Settings,
} from "lucide-react";
...
export default function InvoicesPage() {
  ...
  useEffect(() => {
    fetchInvoices();
  }, [activeClient?.id, statusFilter, sortField, sortOrder]);
  ...
  return (
    <div className="container mx-auto py-6 px-4 md:px-6">
      ...
      <InvoiceSettingsSheet
        ...
        onSaved={() => {
          // Refresh invoices after settings update if needed
          fetchInvoices();
        }}
      />
    </div>
