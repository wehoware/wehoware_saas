...
export default function GenerateReportPage() {
  ...
  const [report, setReport] = useState({
    ...
    date_range_start: new Date(new Date().setDate(new Date().getDate() - 30)).toISOString().split('T')[0], // 30 days ago
  ...
  const handleTemplateChange = (e) => {
    ...
    setReport({
      ...report,
      template_id: id,
      title: template ? `${template.title} - ${new Date().toLocaleDateString()}` : ''
    });
  };
        ...
        switch (selectedTemplate.report_type) {
          case 'analytics':
            reportData = {
              ...
              top_pages: [
                ...
                { page: '/services', views: Math.floor(Math.random() * 800) + 50 },
                { page: '/about', views: Math.floor(Math.random() * 500) + 25 },
                { page: '/contact', views: Math.floor(Math.random() * 300) + 10 },
          ...
          case 'content':
            reportData = {
              ...
              popular_content: [
                { title: 'Sample Blog Post 1', views: Math.floor(Math.random() * 500) + 100 },
                { title: 'Sample Service Page', views: Math.floor(Math.random() * 400) + 80 },
                { title: 'Sample Blog Post 2', views: Math.floor(Math.random() * 300) + 60 },
                { title: 'Sample Case Study', views: Math.floor(Math.random() * 200) + 40 },
                { title: 'Sample Blog Post 3', views: Math.floor(Math.random() * 100) + 20 }
              ]
            };
            break;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <form onSubmit={generateReport} className="bg-white rounded-lg shadow overflow-hidden max-w-3xl mx-auto">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="is_scheduled" className="font-medium text-gray-700">Schedule this report</label>
                      <p className="text-gray-500">Automatically generate updated versions of this report</p>
                    </div>
                  </div>
          ...
          <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-white ${
                selectedTemplate ? 'bg-blue-500 hover:bg-blue-600' : 'bg-gray-300 cursor-not-allowed'
              }`}
            >
