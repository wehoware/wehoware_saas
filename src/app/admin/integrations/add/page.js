...
export default function AddIntegrationPage() {
  ...
  const renderProviderConfig = () => {
    ...
    // This would be expanded with actual provider-specific fields based on the provider
        ...
        return (
          <>
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">Your Mailchimp list/audience ID</p>
            </div>
            <div>
              ...
              <input
                ...
                placeholder="e.g. us1"
              />
              <p className="mt-1 text-xs text-gray-500">The server prefix from your API key (e.g. 'us1')</p>
            </div>
          </>
        );
          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={(e) => handleConfigChange('portal_id', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
              />
              <p className="mt-1 text-xs text-gray-500">Optional: For form submissions</p>
            </div>
          </>
        );
        ...
        return (
          <div>
            ...
            <input
              ...
              onChange={(e) => handleConfigChange('tracking_id', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  ...
                  Additional settings may be required based on your specific use case.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <form onSubmit={saveIntegration} className="bg-white rounded-lg shadow overflow-hidden max-w-3xl mx-auto">
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-1 text-xs text-gray-500">A name to identify this integration</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md"
                  />
                  <p className="mt-1 text-xs text-gray-500">Only required for some providers</p>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <h3 className="text-md font-medium mb-3">Provider-Specific Configuration</h3>
          ...
          <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-white ${
                selectedProvider ? 'bg-blue-500 hover:bg-blue-600' : 'bg-gray-300 cursor-not-allowed'
              }`}
            >
