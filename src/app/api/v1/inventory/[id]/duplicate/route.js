    ...
    try {
      ...
      const duplicate = await prisma.wehowareInventoryItem.create({
        data: {
          ...
          openGraphTitle: original.openGraphTitle,
          openGraphDescription: original.openGraphDescription,
          openGraphImage: original.openGraphImage,
          twitterTitle: original.twitterTitle,
          twitterDescription: original.twitterDescription,
          twitterImage: original.twitterImage,
          canonicalUrl: null,
          robotsMeta: original.robotsMeta,
          schemaType: original.schemaType,
          targetKeywords: original.targetKeywords,
          ctaHeading: original.ctaHeading,
          ctaBody: original.ctaBody,
          ctaButtonText: original.ctaButtonText,
          ctaButtonUrl: original.ctaButtonUrl,
          allowSocialShare: original.allowSocialShare,
          createdBy: user.id,
          updatedBy: user.id,
        },
      });
