...
export default function AddFormTemplate() {
  ...
  const addOption = (fieldIndex) => {
    ...
    updatedFields[fieldIndex].options.push({ label: 'New Option', value: `option_${Date.now()}` });
    setFormFields(updatedFields);
  };
  ...
  const removeNotificationEmail = (email) => {
    setFormTemplate({
      ...formTemplate,
      notification_emails: formTemplate.notification_emails.filter(e => e !== email)
    });
  };
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        disabled={index === 0}
                        className={`p-1 rounded ${index === 0 ? 'text-gray-400' : 'text-gray-700 hover:bg-gray-100'}`}
                      >
                        <ArrowUp />
                      </button>
                      <button
                        ...
                        className={`p-1 rounded ${index === formFields.length - 1 ? 'text-gray-400' : 'text-gray-700 hover:bg-gray-100'}`}
                      >
                        <ArrowDown />
                      </button>
                      <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleFieldChange(index, 'css_class', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md"
                      />
                    </div>
                  </div>
