...
import { ArrowRight, Code, GanttChart, Smartphone, Globe, Zap, BarChart, PenTool, Trophy, Database, ArrowUpRight } from 'lucide-react';
...
export default function Home() {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      description: 'Modern, responsive websites and web applications that drive engagement and deliver results.'
    },
    {
    ...
    },
    {
      ...
      description: 'Results-driven digital marketing strategies that boost your online presence and drive targeted traffic.'
    },
    {
  ...
  return (
    <div className="overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <motion.div
                ...
                <Badge variant="outline" className="px-4 py-1 border-primary/20 bg-primary/5 text-primary rounded-full">Software Development & Marketing</Badge>
              </motion.div>
              ...
              >
                We Build<br/> 
                <span className="text-primary">Digital Solutions</span><br/>
                That Drive Growth
              </motion.h1>
              ...
              >
                Full-service website design, development and digital marketing company specializing in SEO and content marketing solutions that grow your brand.
              </motion.p>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Delivering cutting-edge solutions</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">With 98% client satisfaction</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section className="relative py-24 overflow-hidden bg-muted/30" ref={targetRef}>
      ...
      <section className="py-20 overflow-hidden bg-background">
        <div className="container">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-semibold mb-1">Trusted by Great Companies</h2>
            <p className="text-muted-foreground">Join the companies that trust Wehoware for their digital needs</p>
          </motion.div>
          ...
          >
            ...
            <div className="relative text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Whether you need a new website, custom software, or a comprehensive digital marketing strategy, our team is ready to help you achieve your goals.
              </p>
