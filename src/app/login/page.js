          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 px-4 py-2 border rounded-md focus:ring-2 focus:ring-primary focus:border-transparent"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-10 px-4 py-2 border rounded-md focus:ring-2 focus:ring-primary focus:border-transparent"
                placeholder="••••••••"
              />
              <button
                type="button"
